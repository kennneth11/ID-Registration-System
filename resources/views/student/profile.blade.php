		    ...
		    <div class="container-xl">
                ...
                <div class="row gy-4">
		                ...
		                <div class="green-border app-card app-card-account  d-flex flex-column align-items-start">
						    ...
						    <div class="app-card-body px-4 w-100">
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    <div class="item-label"><strong>Sex</strong></div>
									        <div class="item-data">
												@if($student->Gender == "M")
													Male
												@else
								...
								<div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    <div class="item-label"><strong>Birth Date</strong></div>
									        <div class="item-data">
												{{ date( "F j, Y", strtotime( $student->DateOfBirth)) }}
									        </div>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
								...
								<div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    <div class="item-label"><strong>College Name</strong></div>
									        <div class="item-data">
												{{$student->CollegeName }}
									        </div>
									    </div><!--//col-->
								...
								<div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    <div class="item-label"><strong>Academic Program Name</strong></div>
									        <div class="item-data">
												{{ $student->ProgName }}
									        </div>
									    </div><!--//col-->
	                ...
	                <div style="display:none;" class="col-12 col-lg-6">
		                <div class="app-card app-card-account green-border d-flex flex-column align-items-start">
						    <div class="app-card-header p-3 border-bottom-0">
						        <div class="row align-items-center gx-3">
							        <div class="col-auto">
								        <div class="app-icon-holder">
